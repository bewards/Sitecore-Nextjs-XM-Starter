...
import { withSitecoreContext, trackingApi, TrackingRequestOptions } from '@sitecore-jss/sitecore-jss-nextjs';
        ...
        {!disconnectedMode && (
          <div>
            <p className="alert alert-warning">
              ...
              <a href="https://jss.sitecore.com/docs/fundamentals/services/tracking">tracking documentation</a> to
              enable it.
            </p>
            <div className="row">
            ...
            <div className="row">
              <fieldset className="form-group col-sm">
                ...
                <p>
                  Track arbitrary page views for custom routing or offline use. Note that Layout Service tracks page
                  views by default unless <code>tracking=false</code> is passed in its query string.
                </p>
              ...
              <fieldset className="form-group col-sm">
                ...
                <p>
                  The tracking API supports pushing a whole batch of events in a single request. This can be useful for
                  queuing strategies or offline PWA usage.
                </p>
            ...
            <div className="row">
              <fieldset className="form-group col-sm">
                ...
                <p>
                  Tracking data is not pushed into the xConnect service until your session ends on the Sitecore server.
                  Click this button to instantly end your session and flush the data - great for debugging and testing.
                </p>
                <p className="alert alert-warning">
                  Note: By default <em>anonymous</em> contacts will not be shown in Experience Profile. If your
                  interactions are not showing up in Experience Profile, you may need to{' '}
