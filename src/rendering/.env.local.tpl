...
# in your Sitecore configuration (see \sitecore\config\demosite.config).
...
# value must match your server-side value (see \sitecore\config\demosite.config).
...
SITECORE_API_KEY=6FD03845-4AB4-47CE-9349-2B6FE898D68A
...
# In this case, use this environment variable to provide the value at build time.
SITECORE_API_HOST=https://cm.demosite.localhost
NEXT_PUBLIC_SITECORE_API_HOST=https://cm.demosite.localhost
