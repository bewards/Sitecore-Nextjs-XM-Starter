...
# ref: https://publications.soulcode.agency/improved-init-ps1-for-sitecore-container-development/
...
Add-HostsEntry "cm.demosite.localhost"
if ($Topology -ne "xp0") {
    Add-HostsEntry "cd.demosite.localhost"
}
Add-HostsEntry "id.demosite.localhost"
Add-HostsEntry "www.demosite.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.demosite.localhost"

    if ($Topology -ne "xp0") {
        # CD_HOST
        Set-EnvFileVariable "CD_HOST" -Value "cd.demosite.localhost"
    }

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.demosite.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.demosite.localhost"
