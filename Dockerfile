...
RUN msbuild .\src\Environment\platform\DemoSite.Environment.csproj /p:Configuration=$env:BUILD_CONFIGURATION /m /p:DeployOnBuild=true /p:PublishProfile=Local
